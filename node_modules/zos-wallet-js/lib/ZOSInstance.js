...
var _LendInstance = require('./LendInstance.js');

var _LendInstance2 = _interopRequireDefault(_LendInstance);
...
var _trxHelper = require('./lib/common/trxHelper.js');
...
var _routerTransition = require('./routerTransition.js');
...
var ZosInstance = function () {
  function ZosInstance() {
    _classCallCheck(this, ZosInstance);
  }

  _createClass(ZosInstance, null, [{
    key: 'init',
    ...
    value: function init(settingsAPIs, callback) {
      var errCallback = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;

      var settingsStore = _SettingsStore2.default.getInstance(settingsAPIs);
      (0, _routerTransition2.default)(null, null, callback, true, errCallback);
    }
    ...
    key: 'init_old',
    value: function init_old(connection_url) {
      var urls = [connection_url];
      var connectionManager = new _zosjsWs.Manager({ url: connection_url, urls: urls });
        ...
        return Promise.all([db]).then(function () {
          return Promise.all([_PrivateKeyStore2.default.onLoadDbData().then(function () {
            ...
            return _es.ChainStore.init().then(function () {
              return Promise.all([_AccountStore2.default.loadDbData(_zosjsWs.Apis.instance().chainId)]).then(function () {
    ...
    value: function createAccountWithPassword(name, password, faucet_url, referrer, captcha, captchaid, proposal_registrar) {
      return _WalletActions2.default.createAccountWithPassword(name, password, null, referrer, 0, null, faucet_url, captcha, captchaid, proposal_registrar).then(function (res) {
        if (res.account.proposal) {
          var _result = {};
          _result['name'] = name;
          _result['proposal'] = res.account.proposal;
    ...
    value: function createAccountWithPassword_geetest(name, password, faucet_url, referrer, proposal_registrar, geetest_challenge, geetest_validate, geetest_seccode, user_token) {
      return _WalletActions2.default.createAccountWithPassword_geetest(name, password, null, referrer, 0, null, faucet_url, proposal_registrar, geetest_challenge, geetest_validate, geetest_seccode, user_token).then(function (res) {
        if (res.account.proposal) {
          var _result2 = {};
          _result2['name'] = name;
          _result2['proposal'] = res.account.proposal;
          return Promise.resolve(_result2);
        }
        // let accountInfo = ''
        _AccountStore2.default.onSetPasswordAccount(name);
        var result = {};
    ...
    key: 'is_enc_memo',
    value: function is_enc_memo(fromAccount, toAccount) {
      var application_api = new _ApplicationApi2.default();
      return application_api.is_enc_memo(fromAccount, toAccount).then(function (result) {
        // console.log(result)
        return Promise.resolve(result);
      }).catch(function (error) {
        console.log(error);
    ...
    key: 'getAboutFee',
    value: function getAboutFee(accountName) {
      var fee_asset_id = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '1.3.0';
      var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'transfer';
      var memo = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '';

      return (0, _es.FetchChain)('getAccount', accountName).then(function (from_account) {
        var fee_balance = _es.ChainStore.getAccountBalance(from_account, fee_asset_id);
        return (0, _trxHelper.checkFeeStatusAsync)({
          ...
          var asset = _es.ChainStore.getObject(fee_asset_id);
          return (0, _trxHelper.shouldPayFeeWithAssetAsync)(from_account, fee).then(function (should) {
            var result = {};
    ...
    key: 'transferNoBroadcast',
    value: function transferNoBroadcast(fromAccount, toAccount, amount, asset_id, memo) {
      var fee_asset_id = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : '1.3.0';

      var application_api = new _ApplicationApi2.default();
      return application_api.transfer(fromAccount, toAccount, amount, // 为用户输入的数字乘以此资产类型的精度
      asset_id, memo, true, true, null, null, fee_asset_id, true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
    ...
    value: function process_transaction(tr) {
      return _WalletDb2.default.process_transaction(tr, null, true, [], true);
    }
    ...
    value: function broadcastTransaction(tr, errcallback) {
    ...
    value: function accountLogin(name, password) {
      return _QueryChainStore2.default.accountLogin(name, password);
    }
    ...
    key: 'accountLoginout',
    value: function accountLoginout() {
      return _WalletDb2.default.onLock();
    }
    ...
    key: 'accountIsLoginout',
    value: function accountIsLoginout() {
      return _WalletDb2.default.isLocked();
    }
    ...
    value: function getAccountBalances(name) {
      return _zosjsWs.Apis.instance().db_api().exec('get_named_account_balances', [name, []]);
    }
    ...
    value: function checkAccountExists(name) {
      return _zosjsWs.Apis.instance().db_api().exec('lookup_accounts', [name, 20]);
    }
  }, {
    key: 'getAccountExists',
    value: function getAccountExists(name) {
      return _zosjsWs.Apis.instance().db_api().exec('get_account_by_name', [name]);
    }
    ...
    value: function getTransferInfo(block_num, trx_in_block) {
      ...
      if (_WalletDb2.default.validatePassword(password, true)) {
        return _zosjsWs.Apis.instance().db_api().exec('get_transaction', [block_num, trx_in_block]).then(function (res) {
    ...
    key: 'getAssetList',
    value: function getAssetList() {
      var result = {};
      return _zosjsWs.Apis.instance().bitlender_api().exec('get_asset_by_property', [8 | 0x20]).then(function (res_loan) {
        // 可借贷货币
        result['cash_list'] = res_loan;
        return _zosjsWs.Apis.instance().bitlender_api().exec('get_asset_by_property', [2]).then(function (res_lender) {
          // 可抵押货币
    ...
    key: 'getAccountPrivate',
    value: function getAccountPrivate(uid) {
      var result = {};
      return _zosjsWs.Apis.instance().db_api().exec('get_committee_member_by_account', [uid]).then(function (com) {
        result['committee_member'] = com;
        return _zosjsWs.Apis.instance().db_api().exec('get_witness_by_account', [uid]).then(function (wit) {
          result['witness'] = wit;
          return Promise.resolve(result);
        }).catch(function (error) {
          console.log(error);
    ...
    value: function getAssetListByType() {
      var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0x00000080;

      return _zosjsWs.Apis.instance().bitlender_api().exec('get_asset_by_property', [type]).then(function (res_loan) {
        // 可借贷货币
        return res_loan;
      });
    }
    ...
    value: function bitlender_lend_order(user_id, carrier_id, // 运营商账号
    ...
    collateral_rate) // 手续费资产ID
    {
      var fee_asset_id = arguments.length > 13 && arguments[13] !== undefined ? arguments[13] : '1.3.0';

      var application_api = new _ApplicationApi2.default();
      return application_api.bitlender_lend_order(user_id, // 借款人ID
      carrier_id, // 运营商ID
      loan_asset_id, // 借款资产ID
      loan_amount, // 借款数量
      loan_asset_precision, // 借款资产精度
    ...
    value: function bitlender_add_collateral(user_id, // 用户ID
    order_id, //
    collateralize_ammount, // 抵押数量
    collateralize_asset_id, // 抵押资产ID
    collateralize_asset_precision, // 抵押资产精度
    collateral_rate) // 手续费资产ID
    {
      ...
      var application_api = new _ApplicationApi2.default();
      return application_api.bitlender_add_collateral(user_id, // 借款人ID
      order_id, // '1.19.x'
      collateralize_ammount, // 抵押数量
      collateralize_asset_id, // 抵押资产ID
      collateralize_asset_precision, // 抵押资产精度
    ...
    value: function bitlender_invest(user_id, // 投资人ID
    loan_id, // 借款人ID
    carrier_id, // 运营商账号
    order_id, //
    invest_ammount, // 投资数量
    invest_asset_id, // 投资资产ID
    invest_asset_precision) // 手续费资产ID
    {
      var fee_asset_id = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : '1.3.0';

      var application_api = new _ApplicationApi2.default();
      return application_api.bitlender_invest(user_id, // 投资人ID
      loan_id, // 借款人ID
      carrier_id, // 运营商ID
      order_id, // '1.19.x'
      invest_ammount, // 投资数量
    ...
    value: function bitlender_repay_interest(user_id, order_id, //
    repay_period) // 手续费资产ID
    {
      ...
      // }
      var application_api = new _ApplicationApi2.default();
      return application_api.bitlender_repay_interest(user_id, // 借款人ID
      order_id, //
      repay_period, // 第几期,整数
      fee_asset_id, // 手续费资产ID
      true).then(function (tr) {
    ...
    value: function bitlender_overdue_interest(user_id, order_id, //
    repay_period) // 手续费资产ID
    {
      var fee_asset_id = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '1.3.0';
      ...
      // }
      var application_api = new _ApplicationApi2.default();
      return application_api.bitlender_overdue_interest(user_id, // 借款人ID
      order_id, //
      repay_period, // 第几期,整数
      fee_asset_id, // 手续费资产ID
      true).then(function (tr) {
    ...
    value: function bitlender_repay_principal(user_id, order_id) // 手续费资产ID
    {
      ...
      // }
      var application_api = new _ApplicationApi2.default();
      return application_api.bitlender_repay_principal(user_id, // 借款人ID
      order_id, //
      fee_asset_id, // 手续费资产ID
      true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
    ...
    value: function bitlender_overdue_repay(user_id, order_id) // 手续费资产ID
    {
      var fee_asset_id = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '1.3.0';
      ...
      // }
      var application_api = new _ApplicationApi2.default();
      return application_api.bitlender_overdue_repay(user_id, // 借款人ID
      order_id, //
      fee_asset_id, // 手续费资产ID
      true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
    ...
    value: function bitlender_prepayment(user_id, order_id) // 手续费资产ID
    {
      var fee_asset_id = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '1.3.0';
      ...
      // }
      var application_api = new _ApplicationApi2.default();
      return application_api.bitlender_prepayment(user_id, // 借款人ID
      order_id, //
      fee_asset_id, // 手续费资产ID
      true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
    ...
    value: function bitlender_remove_operation(user_id, order_id) // 手续费资产ID
    {
      var fee_asset_id = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '1.3.0';
      ...
      // }
      var application_api = new _ApplicationApi2.default();
      return application_api.bitlender_remove_operation(user_id, // 借款人ID
      order_id, //
      fee_asset_id, // 手续费资产ID
      true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
    ...
    value: function bitlender_setautorepayer(user_id, order_id, bset) // 手续费资产ID
    {
      var fee_asset_id = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '1.3.0';
      ...
      // }
      var application_api = new _ApplicationApi2.default();
      return application_api.bitlender_setautorepayer(user_id, // 借款人ID
      order_id, bset, //
      fee_asset_id, // 手续费资产ID
      true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
    ...
    value: function locktoken_create(user_id, user_to, asset_id, amount, period, type, mode) {
      ...
      var application_api = new _ApplicationApi2.default();
      return application_api.locktoken_create(user_id, user_to, asset_id, amount, period, type, mode, fee_asset_id, true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
        fee_obj['fee_amount'] = tran_ser.operations[0][1].fee.amount;
    ...
    value: function locktoken_update(user_id, object_id, op_type, asset_id, amount, period, type, mode) {
      ...
      var application_api = new _ApplicationApi2.default();
      return application_api.locktoken_update(user_id, object_id, op_type, asset_id, amount, period, type, mode, fee_asset_id, true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
        fee_obj['fee_amount'] = tran_ser.operations[0][1].fee.amount;
    ...
    value: function locktoken_remove(user_id, object_id) {
      ...
      var application_api = new _ApplicationApi2.default();
      return application_api.locktoken_remove(user_id, object_id, fee_asset_id, true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
        fee_obj['fee_amount'] = tran_ser.operations[0][1].fee.amount;
    ...
    key: 'asset_locktoken_assign',
    value: function asset_locktoken_assign(user_id, asset_id, sparam) {
      var fee_asset_id = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '1.3.0';

      var application_api = new _ApplicationApi2.default();
      var obj = _es.ChainStore.getObject('2.1.0');
      var chain_time = obj.get('time');
      return application_api.asset_locktoken_operation(user_id, asset_id, user_id, 2, sparam, chain_time, fee_asset_id, true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
        fee_obj['fee_amount'] = tran_ser.operations[0][1].fee.amount;
    ...
    value: function asset_locktoken_operation(user_id, asset_id, asset_owner, isNew, sparam) {
      var fee_asset_id = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : '1.3.0';

      var application_api = new _ApplicationApi2.default();
      var obj = _es.ChainStore.getObject('2.1.0');
      var chain_time = obj.get('time');
      return application_api.asset_locktoken_operation(user_id, asset_id, asset_owner, isNew ? 1 : 0, sparam, chain_time, fee_asset_id, true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
        fee_obj['fee_amount'] = tran_ser.operations[0][1].fee.amount;
    ...
    value: function limit_order_create(seller, amount_to_sell, min_to_receive, fill_mode, expiration) {
      var fill_or_kill = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : false;
      var fee_asset_id = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : '1.3.0';

      var application_api = new _ApplicationApi2.default();
      return application_api.limit_order_create(seller, '1.2.0', amount_to_sell, min_to_receive, '', fill_mode, expiration, fill_or_kill, fee_asset_id, true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
        fee_obj['fee_amount'] = tran_ser.operations[0][1].fee.amount;
    ...
    value: function limit_order_cancel(seller, order) {
      ...
      var application_api = new _ApplicationApi2.default();
      return application_api.limit_order_cancel(seller, order, fee_asset_id, true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
        fee_obj['fee_amount'] = tran_ser.operations[0][1].fee.amount;
    ...
    value: function vesting_balance_withdraw(user_id, object_id, asset_id, amount) {
      ...
      var application_api = new _ApplicationApi2.default();
      return application_api.vesting_balance_withdraw(user_id, object_id, asset_id, amount, fee_asset_id, true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
        fee_obj['fee_amount'] = tran_ser.operations[0][1].fee.amount;
    ...
    key: 'get_loan_info',
    value: function get_loan_info(loan_amount, // 借款数量 (要乘以精度)
    loan_asset_id, // 借款资产ID
    loan_period, // 借款周期，月
    ...
    collateralize_asset_id // 抵押资产ID
      ...
      //     return Promise.reject("account is no Exists")
      // }
      var loan_asset = { amount: loan_amount, asset_id: loan_asset_id };
      var key = ZosInstance.getOptionKey(repaymet_type);
      var collateral_asset = { amount: 0, asset_id: collateralize_asset_id };
      return _zosjsWs.Apis.instance().bitlender_api().exec('get_loan_info', [loan_asset, loan_period, interest_rate, bid_period, collateralRatio, collateral_asset, key]).then(function (res_obj) {
        ...
        result['feed_price'] = _QueryChainStore2.default.calcFeedPrice(res_obj.price_settlement.settlement_price, res_obj.asset_to_loan.id, res_obj.asset_to_loan.precision, res_obj.asset_to_collateralize.id, res_obj.asset_to_collateralize.precision);
        result['feed_price_view'] = _QueryChainStore2.default.calcFeedPriceView(res_obj.price_settlement.settlement_price, res_obj.asset_to_loan.id, res_obj.asset_to_loan.precision, res_obj.asset_to_collateralize.id, res_obj.asset_to_collateralize.precision);
    ...
    key: 'get_object',
    value: function get_object(id) {
      return (0, _es.FetchChain)('getObject', id, 5000).then(function (res_obj) {
        return res_obj;
      });
    }
    ...
    key: 'get_account',
    value: function get_account(id) {
      return (0, _es.FetchChain)('getAccount', id, 5000).then(function (res_obj) {
        return res_obj;
      });
    }
    ...
    key: 'calc_string',
    value: function calc_string(order_id, type) {
      return _zosjsWs.Apis.instance().bitlender_api().exec('calc_string', [order_id, type]).then(function (res) {
        return res;
      });
    }
    ...
    value: function get_loan_collateralize(loan_asset_id, loan_asset_amount, collateralize_id) {
      return _QueryChainStore2.default.get_loan_collateralize(loan_asset_id, loan_asset_amount, collateralize_id);
    }
    // 对身份进行签名
    ...
    value: function signAuthInfo(account_id) {
      ...
      var account = null;
      if (cur_account) {
        account = _es.ChainStore.getAccount(cur_account, true);
      }
      if (!account) {
        return Promise.reject('account is no Exists');
      }
      ...
      return _QueryChainStore2.default.signAuthInfo(account_id).then(function (trx) {
        return trx.finalize().then(function () {
          trx.sign();
          return trx.toObject();
        });
      });
    ...
    value: function signTrx(account_id, trx_param) {
      ...
      // let keys = key_auths.map(a => a.get(0));
      // let private_key = WalletDb.getPrivateKey(keys.get(0))
      var buf_bin = Buffer.from(JSON.stringify(trx_param));
      var buf = buf_bin.toString('hex');
      return _QueryChainStore2.default.signTrx(account_id, buf).then(function (trx) {
        return trx.finalize().then(function () {
          trx.sign();
          return trx.toObject();
        });
    ...
    value: function getRealNum(amount, precision) {
      return _QueryChainStore2.default.getRealNum(amount, precision);
    }
    ...
    value: function getHistoryList(account_id, start) {
      ...
      return _QueryChainStore2.default.getHistoryList(account_id, start, limit);
    }
    ...
    key: 'get_account_bitlender_history',
    value: function get_account_bitlender_history(account_id, order_id) {
      return _zosjsWs.Apis.instance().history_api().exec('get_account_bitlender_history', [account_id, order_id]).then(function (res_list) {
        return res_list;
      });
    }
    // // 获取我的历史借款订单中的投资列表信息
    ...
    key: 'account_update',
    value: function account_update(account_id, // 用户ID
    memo) {
      var fee_asset_id = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '1.3.0';
      var confirm = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;

      var application_api = new _ApplicationApi2.default();
      return application_api.account_update(account_id, memo, fee_asset_id, // 手续费资产ID
      true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
    ...
    type) {
      return _QueryChainStore2.default.get_encode_memo(account_id, fix_account_name, memo, type);
    }
    ...
    key: 'get_account_memo',
    value: function get_account_memo(account_id) {
      return (0, _es.FetchChain)('getAccount', account_id, 5000).then(function (res_acc) {
        if (_WalletDb2.default.isLocked()) {
          return false;
        }
        if (res_acc) {
          if (res_acc.memo) {
            var memo_obj = res_acc.memo;
            return Promise.resolve(_PrivateKeyStore2.default.decodeMemo(memo_obj).text);
          } else {
            var nResult = '{}';
    ...
    key: 'get_decode_memo',
    value: function get_decode_memo(account_id, memo_obj // 加密后的用户信息串
    ) {
      return (0, _es.FetchChain)('getAccount', account_id, 5000).then(function (res_acc) {
        if (_WalletDb2.default.isLocked()) {
          return false;
    ...
    key: 'get_noenc_memo',
    value: function get_noenc_memo(memo_obj // 加密后的用户信息串
    ) {
      return Promise.resolve(_PrivateKeyStore2.default.decodeMemo_noenc(memo_obj).text);
    }
    // 获取提前/逾期还本所需的违约金和本金

  }, {
    key: 'get_repay_fee',
    value: function get_repay_fee(order_id) {
      return _zosjsWs.Apis.instance().bitlender_api().exec('get_repay_fee', [order_id]).then(function (res) {
        var result = {};
        if (res) {
    ...
    key: 'get_invest_fee',
    value: function get_invest_fee(order_id, repay_period) {
      return _zosjsWs.Apis.instance().bitlender_api().exec('get_invest_fee', [order_id, repay_period]).then(function (res) {
        var result = {};
        if (res) {
    ...
    value: function CheckNode() {
      gatewayurl.forEach(function (item) {});
    }
  }, {
    key: 'setLockTime',
    value: function setLockTime() {
      var uT = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 600;
    ...
    key: 'activateNode',
    value: function activateNode(url, callback) {
      var errCallback = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      ...
      setTimeout(function () {
        (0, _routerTransition2.default)(null, null, callback, false, errCallback);
      }, 50);
    }
  }, {
    key: 'setStoreKey',
    value: function setStoreKey(key) {
      _SettingsStore2.default.setKey(key);
    }
    ...
    key: 'deleteNode',
    value: function deleteNode(url) {
      var settingsStore = _SettingsStore2.default.getInstance();
      var removeIndex = -1;
      settingsStore.defaults['apiServer'].forEach(function (api, index) {
        if (api.url === url) {
          removeIndex = index;
        }
      });
    ...
    key: 'setReplaceAddress',
    value: function setReplaceAddress(x) {
      console.log(x);
      replaceUrl = x;
    }
  }, {
    key: 'ReplaceAddress',
    value: function ReplaceAddress(x) {
      if (replaceUrl !== '') {
    ...
    key: 'setFaucetAddress',
    value: function setFaucetAddress(faucet_url) {
      var settingsStore = _SettingsStore2.default.getInstance();
    ...
    key: 'getFaucetAddress',
    value: function getFaucetAddress() {
      var settingsStore = _SettingsStore2.default.getInstance();
      var retStr = settingsStore.settings.get('faucet_address');
    ...
    value: function getNodelist() {
      ...
      var nodes = apiServer.map(function (node) {
        return _QueryChainStore2.default.getNode(node);
      }).filter(function (node) {
        return node.hidden !== true;
      });
      var currentNodeIndex = _QueryChainStore2.default.getCurrentNodeIndex();
      nodes = nodes.slice(0, currentNodeIndex).concat(nodes.slice(currentNodeIndex + 1)).sort(function (a, b) {
        var isTestnet = false; //  a.url === testnetAPI.url || a.url === testnetAPI2.url;
        if (a.url == autoSelectAPI) {
          return -1;
        } else if (a.up && b.up) {
          return a.ping - b.ping;
    ...
    value: function getActiveNode() {
      var settingsStore = _SettingsStore2.default.getInstance();
      var currentNodeIndex = _QueryChainStore2.default.getCurrentNodeIndex();
      var activeNode = _QueryChainStore2.default.getNode(settingsStore.defaults.apiServer[currentNodeIndex] || settingsStore.defaults.apiServer[0]);
      return activeNode;
    }
    ...
    key: 'getCurrentNodePing',
    value: function getCurrentNodePing() {
      var settingsStore = _SettingsStore2.default.getInstance();
      var currentNode = settingsStore.settings.get('activeNode');
      var currentNodePing = settingsStore.apiLatencies[currentNode];
    ...
    key: 'getAccountPublicKey',
    value: function getAccountPublicKey(account_id) {
      return (0, _es.FetchChain)('getAccount', account_id, 5000).then(function (res_acc) {
        if (res_acc) {
          var active = res_acc.get('active');
          var owner = res_acc.get('owner');
          ...
          var memo_key = res_acc.get('options').get('memo_key');
          var auth_key = res_acc.get('options').get('auth_key');

          var ary_active_keys = [];
          active_keys.map(function (k) {
            ary_active_keys.push(k);
          });

          var ary_owner_keys = [];
          owner_keys.map(function (k) {
    ...
    key: 'getAccountPrivateKey',
    value: function getAccountPrivateKey(pubkey) {
      var private_key = _WalletDb2.default.getPrivateKey(pubkey);
    ...
    value: function gateway_withdraw(fromAccount, // 提币人用户名
    toAccount, // 网关用户名
    amount, // 提币数量，用户输入的数量
    asset_id) // 燃料费ID
    {
      ...
      var application_api = new _ApplicationApi2.default();
      return application_api.gateway_withdraw(fromAccount, toAccount, amount, // 为用户输入的数字乘以此资产类型的精度
      asset_id, fee_asset_id, true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
        fee_obj['fee_amount'] = tran_ser.operations[0][1].fee.amount;
    ...
    key: 'get_user_phoneinfo',
    value: function get_user_phoneinfo(account_id) {
      return ZosInstance.get_user_baseinfo(account_id).then(function (res) {
        if (res) {
          ...
          if (userinfo !== undefined) {
            ...
            return ZosInstance.get_decode_memo(account_id, baseInfo).then(function (info) {
              if (!info) {
                return undefined;
              } else {
    ...
    key: 'get_user_baseinfo',
    value: function get_user_baseinfo(account_id) {
      var result = {};
      return (0, _es.FetchChain)('getAccount', account_id, 5000).then(function (account) {
        if (account) {
          var account_name = account.get('name');
          var registrar = account.get('registrar');
          var referrer = account.get('referrer');
          return Promise.all([(0, _es.FetchChain)('getAccount', registrar), (0, _es.FetchChain)('getAccount', referrer)]).then(function (res) {
            ...
            var registrar_name = chain_registrar.get('name');
            var referrer_name = chain_referrer.get('name');
    ...
    key: 'encodePin',
    value: function encodePin(pin_password, // pin码
    account_password // 用户密码
    ) {
      return _QueryChainStore2.default.encodePin(pin_password, account_password);
    }
    ...
    key: 'decodePin',
    value: function decodePin(pin_password, // pin码
    enc_pw // 加密字符串
    ) {
      return _QueryChainStore2.default.decodePin(pin_password, enc_pw);
    }
    ...
    value: function get_random_password() {
      return _QueryChainStore2.default.get_random_password();
    }
    ...
    key: 'getAssetExchangeFeed',
    value: function getAssetExchangeFeed(source_asset_id, source_precision, dest_asset_id, dest_precision) {
      var feed = 0.0;
      if (source_asset_id === dest_asset_id) return Promise.resolve(1.0);
      return _zosjsWs.Apis.instance().db_api().exec('get_asset_exchange_feed', [dest_asset_id, source_asset_id, 1]).then(function (res_obj) {
        if (res_obj && res_obj.current_feed && res_obj.current_feed.settlement_price) {
          feed = _QueryChainStore2.default.calcFeedPrice(res_obj.current_feed.settlement_price, dest_asset_id, dest_precision, source_asset_id, source_precision);
          return Promise.resolve(feed);
        } else {
          return _zosjsWs.Apis.instance().db_api().exec('get_asset_exchange_feed', [dest_asset_id, source_asset_id, 0]).then(function (res_obj) {
            if (res_obj && res_obj.current_feed && res_obj.current_feed.settlement_price) {
              feed = _QueryChainStore2.default.calcFeedPrice(res_obj.current_feed.settlement_price, dest_asset_id, dest_precision, source_asset_id, source_precision);
              return Promise.resolve(feed);
            } else {
    ...
    key: 'getAssetCoreFeed',
    value: function getAssetCoreFeed(source_asset_id, source_precision, dest_asset_id, dest_precision) {
      var feed = 0.0;
      if (source_asset_id === dest_asset_id) return Promise.resolve(1.0);
      return _zosjsWs.Apis.instance().db_api().exec('get_asset_exchange_feed', [dest_asset_id, source_asset_id, 0]).then(function (res_obj) {
        if (res_obj && res_obj.current_feed && res_obj.current_feed.settlement_price) {
    ...
    key: 'account_coupon',
    value: function account_coupon(account_id) // 手续费资产ID
    {
      var fee_asset_id = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '1.3.0';

      var application_api = new _ApplicationApi2.default();
      return application_api.account_coupon(account_id, // 借款人ID
      fee_asset_id, // 手续费资产ID
      true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
    ...
    key: 'add_custom',
    value: function add_custom(account_id, required_auths, id, data) // 手续费资产ID
    {
      var fee_asset_id = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : '1.3.0';

      var application_api = new _ApplicationApi2.default();
      return application_api.add_custom(account_id, // 借款人ID
      required_auths, id, data, fee_asset_id, // 手续费资产ID
      true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
    ...
    key: 'get_account_coupon',
    value: function get_account_coupon(account_id) {
      var result = {};
      return _zosjsWs.Apis.instance().db_api().exec('get_accounts_statistics', [[account_id]]).then(function (res_acc) {
        var statistics = res_acc[0];
        var coupon_month = statistics.coupon_month;
        var obj0 = _es.ChainStore.FetchChain('getObject', '1.3.0', 5000);
        var obj1 = _es.ChainStore.FetchChain('getObject', '2.1.0', 5000);
        var obj2 = _es.ChainStore.FetchChain('getObject', '2.0.0', 5000);
        return Promise.all([obj0, obj1, obj2]).then(function (resObj) {
          var amount = parseInt(statistics.amount_coupon) / Math.pow(10, resObj[0].get('precision'));
          var oDate = new Date(resObj[1].get('time'));
          var oIDate = new Date(resObj[2].get('initial_time'));
          var oMonth = oDate.getMonth();
          var oYear = oDate.getFullYear();
          var calDate = parseInt(oYear) * 100 + parseInt(oMonth) + 1;
          var canReceiveCoupon = true;
          var canReceiveCouponTime = true;
          var coupon_per_month = resObj[2].get('parameters').get('coupon_per_month');
          var coupon_expire_time = resObj[2].get('parameters').get('coupon_expire_time');
    ...
    value: function get_account_info(account, fee_asset_id, auth_pub, auth_priv) {
      var auth_data_info = _QueryChainStore2.default.memfromImmutableObj(account.getIn(['auth_data', 'info']));
      var auth_data_key = _QueryChainStore2.default.memfromImmutableObj(account.getIn(['auth_data', 'key']));
      var user_info = _QueryChainStore2.default.memfromImmutableObj(account.get('user_info'));
      var auth_key = account.getIn(['options', 'auth_key']);
      var issuer = account.get('id');

      console.log(auth_data_info, auth_data_key, user_info);

      var trxex = new _es.TransactionBuilder();
      if (auth_data_info && auth_data_info.from === auth_key || auth_data_key && auth_data_key.from === auth_key) {
        ...
        if (auth_data_info && auth_data_info.from === auth_key) {
          try {
            info = _PrivateKeyStore2.default.decodeMemo(auth_data_info).text;
          } catch (err) {
            info = '';
        ...
        if (auth_data_key && auth_data_key.from === auth_key) {
          try {
            key = _PrivateKeyStore2.default.decodeMemo(auth_data_key).text;
          } catch (err) {
            key = '';
        ...
        if (info && info !== '' || key && key !== '') {
          ...
          if (info && info !== '') {
            ...
            auth_param.info.message = _es.Aes.encrypt_with_checksum(auth_priv, auth_param.info.to, auth_param.info.nonce, info);
          }
          if (key && key !== '') {
            auth_param.key = auth_data_key;
            auth_param.key.from = auth_pub;
            auth_param.key.message = _es.Aes.encrypt_with_checksum(auth_priv, auth_param.key.to, auth_param.key.nonce, key);
          }
      ...
      if (user_info && user_info.from === auth_key) {
        var _info = '';
        try {
          _info = _PrivateKeyStore2.default.decodeMemo(user_info).text;
        } catch (err) {
          _info = '';
        ...
        if (_info && _info !== '') {
          ...
          _auth_param.info = user_info;
          _auth_param.info.from = auth_pub;
          _auth_param.info.message = _es.Aes.encrypt_with_checksum(auth_priv, _auth_param.info.to, _auth_param.info.nonce, _info);
          trxex.add_type_operation('account_authenticate', {
            fee: {
              amount: 0,
              asset_id: fee_asset_id
    ...
    key: 'set_chain_password',
    value: function set_chain_password(name, old_password, new_password) // 手续费资产ID
    {
      var fee_asset_id = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '1.3.0';

      var vid = _QueryChainStore2.default.accountLogin(name, old_password);
      if (!vid) {
        return Promise.reject('Your old password is incorrect');
      }
      return (0, _es.FetchChain)('getAccount', name, 5000).then(function (account) {
        var active = _QueryChainStore2.default.permissionsFromImmutableObj(account.get('active'));
        var owner = _QueryChainStore2.default.permissionsFromImmutableObj(account.get('owner'));
        var memo_key = account.get('options').get('memo_key');
        var auth_key = account.get('options').get('auth_key');

        var old_active_pub = _WalletDb2.default.generateKeyFromPassword(name, 'active', old_password).pubKey;
        var old_owner_pub = _WalletDb2.default.generateKeyFromPassword(name, 'owner', old_password).pubKey;

        var new_active = _WalletDb2.default.generateKeyFromPassword(name, 'active', new_password).pubKey;
        var new_owner = _WalletDb2.default.generateKeyFromPassword(name, 'owner', new_password).pubKey;
        var new_memo = _WalletDb2.default.generateKeyFromPassword(name, 'active', new_password).pubKey;
        var auth_memo = _WalletDb2.default.generateKeyFromPassword(name, 'author', new_password).pubKey;
        var auth_priv = _WalletDb2.default.generateKeyFromPassword(name, 'author', new_password).privKey;
        ...
        var s_active = state['active_keys'].set(index, new_active);
        ...
        if (_QueryChainStore2.default.didChange('active', state)) {
          updateObject.active = _QueryChainStore2.default.permissionsToJson(state.active_threshold, state.active_accounts, state.active_keys, state.active_addresses, state.active_weights);
        ...
        if (_QueryChainStore2.default.didChange('owner', state)) {
          updateObject.owner = _QueryChainStore2.default.permissionsToJson(state.owner_threshold, state.owner_accounts, state.owner_keys, state.owner_addresses, state.owner_weights);
        }
        if (_QueryChainStore2.default.didChange('owner', state) && state.owner_keys.size === 0 && state.owner_addresses.size === 0 && state.owner_accounts.size === 1 && state.owner_accounts.first() === updated_account.id) {
        ...
        if (state.memo_key && _QueryChainStore2.default.didChange('memo', state) && _QueryChainStore2.default.isValidPubKey(state.memo_key) || state.auth_key && _QueryChainStore2.default.didChange('auth', state) && _QueryChainStore2.default.isValidPubKey(state.auth_key)) {
        ...
        var trxex = ZosInstance.get_account_info(account, fee_asset_id, auth_memo, auth_priv);
        var application_api = new _ApplicationApi2.default();
        return application_api.update_account(updateObject, trxex).then(function (tr) {
          var asset = _es.ChainStore.getObject(fee_asset_id);
          var tran_ser = tr.serialize();
          var fee_obj = {};
          fee_obj['fee_amount'] = tran_ser.operations[0][1].fee.amount;
    ...
    value: function get_vote_objects(type) {
      return _QueryChainStore2.default.get_vote_objects(type);
    }

    // 获取可借贷资产列表

  }, {
    key: 'getLoanAssetList',
    value: function getLoanAssetList() {
      return _zosjsWs.Apis.instance().bitlender_api().exec('get_asset_by_property', [8]).then(function (res_loan) {
        // 可借贷货币
    ...
    key: 'getAuthsFromAccount',
    value: function getAuthsFromAccount(account_id) {
      var result = [];
      return _zosjsWs.Apis.instance().db_api().exec('get_accounts', [[account_id]]).then(function (account_list) {
        if (!account_list[0]) {
          return Promise.reject("Can't find the account " + account_id);
        }
        var acc_id_ary = [];
        account_list[0].active.account_auths.forEach(function (item, index) {
          acc_id_ary.push(item[0]);
        });
        return _zosjsWs.Apis.instance().db_api().exec('get_accounts', [acc_id_ary]).then(function (account_list) {
    ...
    key: 'can_edit_bitlender_option',
    value: function can_edit_bitlender_option(bitlender_option_id, account_id, type) {
      var key = ZosInstance.getOptionKey(type);
      return _zosjsWs.Apis.instance().bitlender_api().exec('can_edit_bitlender_option', [bitlender_option_id, account_id, key]).then(function (can_edit) {
        return can_edit;
      });
    }
    ...
    key: 'get_proposals',
    value: function get_proposals(account_id) {
      var result = [];
      return _zosjsWs.Apis.instance().db_api().exec('get_proposed_transactions', [account_id]).then(function (propos) {
        return new Promise(function (resolve, reject) {
          _async2.default.each(propos, function (res, allcallback) {
            var obj = {};
            var operations = res.proposed_transaction.operations; // 此operations是个数组，展示的时候要注意
            var type = res.required_active_approvals.length ? 'active' : 'owner';
            var str_available = 'available_' + type + '_approvals';
            var available = res[str_available]; // 同意的列表
            var availableKeys = res['available_key_approvals'];
            var str_required = 'required_' + type + '_approvals';
            var required = res[str_required]; // 必要的账号的列表
            obj['id'] = res.id; // 提案ID
            obj['expiration_time'] = _QueryChainStore2.default.getTimezoneDate(res.expiration_time); // 截止时间
            obj['create_time'] = _QueryChainStore2.default.getTimezoneDate(res.create_time); // 截止时间
            ...
            return (0, _es.FetchChain)('getAccount', required).then(function (requ_accountlist) {
              var approval_list = [];
              requ_accountlist.forEach(function (requ_accounts, index) {
                var typelist = requ_accounts.getIn([type, 'account_auths']).toJS();
                var approval = typelist.map(function (a) {
                  return a[0];
                }).filter(function (id_item) {
                  var id = id_item;
              ...
              return Promise.all([(0, _es.FetchChain)('getAccount', approval_list), (0, _es.FetchChain)('getAccount', res.proposer)]).then(function (res_accounts) {
                var acc_objs = [];

                var _res_accounts = _slicedToArray(res_accounts, 2),
                    ava_accounts = _res_accounts[0],
                    proposer_acc = _res_accounts[1];

                obj['proposer'] = proposer_acc.get('name'); // 发起人名字
                obj['proposer_id'] = res.proposer; // 发起人ID
                ava_accounts.forEach(function (item, index) {
                  if (item) {
                    var acc_obj = {};
    ...
    value: function get_propos_required_list(propos_id) {
      ...
      return _QueryChainStore2.default.get_propos_required_list(propos_id, op_type);
    }
    ...
    key: 'proposal_update',
    value: function proposal_update(propos_id, accountMap, keyMap, op_type, type, pay_account_id, sel_account_name) {
      var fee_asset_id = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : '1.3.0';

      return _zosjsWs.Apis.instance().db_api().exec('get_objects', [[propos_id]]).then(function (proposList) {
        var propos = proposList[0];
        var proposal = {
        ...
        ['active', 'owner', 'key'].forEach(function (auth_type) {
          var value = state[auth_type];
          if (value) {
            var str_type = 'available_' + auth_type + '_approvals';
            var hasValue = propos[str_type].indexOf(value) !== -1;
        ...
        var application_api = new _ApplicationApi2.default();
        return application_api.proposal_update(proposal, neededKeys, true).then(function (tr) {
          var asset = _es.ChainStore.getObject(fee_asset_id);
          var tran_ser = tr.serialize();
          var fee_obj = {};
          fee_obj['fee_amount'] = tran_ser.operations[0][1].fee.amount;
    ...
    key: 'bitlender_option_carriers_update',
    value: function bitlender_option_carriers_update(issuer, author, option_id, options, loanCarrier, investCarriers) {
      var fee_asset_id = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : '1.3.0';
      ...
      for (var index = 0; index < investCarriers.length; index++) {
        var id = investCarriers[index].id;
        var aid = '1.3.' + id.substr(4);
      ...
      return application_api.bitlender_option_update(issuer, author, option_id, options, fee_asset_id, // 手续费资产ID
      chain_time, true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
        fee_obj['fee_amount'] = tran_ser.operations[0][1].fee.amount;
    ...
    value: function bitlender_option_create(issuer, asset_id, sproduct, options) {
      var fee_asset_id = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : '1.3.0';

      var application_api = new _ApplicationApi2.default();
      var obj = _es.ChainStore.getObject('2.1.0');
      var chain_time = obj.get('time');
      return application_api.bitlender_option_create(issuer, asset_id, sproduct, options, fee_asset_id, // 手续费资产ID
      chain_time, true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
    ...
    value: function bitlender_option_update(issuer, author, option_id, options) {
      var fee_asset_id = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : '1.3.0';
    ...
    value: function bitlender_rate_update(option_id, issuer, interest_rate_add, interest_rate_remove, type) {
      var fee_asset_id = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : '1.3.0';

      var application_api = new _ApplicationApi2.default();
      return application_api.bitlender_rate_update(option_id, issuer, interest_rate_add, interest_rate_remove, fee_asset_id, // 手续费资产ID
      true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
    ...
    value: function bitlender_recycle(issuer, order_id, asset_pay, memo) {
      var fee_asset_id = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : '1.3.0';

      var application_api = new _ApplicationApi2.default();
      return application_api.bitlender_recycle(issuer, order_id, asset_pay, memo, fee_asset_id, // 手续费资产ID
      true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
    ...
    key: 'get_NPL_feed',
    value: function get_NPL_feed(collateral_asset_id, collateral_bitasset_data_id, collateral_precision, borrow_asset_id, borrow_bitasset_data_id, borrow_precision) {
      var result = {};
      ...
      // }
      return _zosjsWs.Apis.instance().db_api().exec('get_asset_exchange_feed', [borrow_asset_id, collateral_asset_id, 1]).then(function (res_obj) {
        var feed = null;
        if (res_obj) {
          if (res_obj.current_feed) {
            if (res_obj.current_feed.settlement_price) {
        ...
        result['feed_price'] = _QueryChainStore2.default.calcFeedPrice(feed, collateral_precision, borrow_precision);
        result['feed_price_view'] = _QueryChainStore2.default.calcFeedPriceView(feed, collateral_precision, borrow_precision);
        return Promise.resolve(result);
      });
    }
    ...
    key: 'lookup_carrier_accounts',
    value: function lookup_carrier_accounts() {
      var lower_bound_name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'A';
      var limit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 100;

      var result = [];
      return _zosjsWs.Apis.instance().db_api().exec('lookup_carrier_accounts', [lower_bound_name, limit]).then(function (res_list) {
        return new Promise(function (resolve, reject) {
          _async2.default.each(res_list, function (res, allcallback) {
            var obj_ary = [];
            _zosjsWs.Apis.instance().db_api().exec('get_account_by_name', [res[0]]).then(function (account_obj) {
    ...
    key: 'get_gateway_url',
    value: function get_gateway_url(asset_id) {
      var result = [];
      return _zosjsWs.Apis.instance().db_api().exec('get_objects', [[asset_id]]).then(function (res_list) {
        return new Promise(function (resolve, reject) {
          _async2.default.each(res_list[0].whitelist_gateways, function (res, allcallback) {
            if (!res || res === '') {
              allcallback(null);
              return;
            }
            _zosjsWs.Apis.instance().db_api().exec('get_gateway_by_account', [res]).then(function (gateway_obj) {
              if (gateway_obj.url) {
    ...
    key: 'get_safe_runtime',
    value: function get_safe_runtime() {
      var obj = _es.ChainStore.getObject('2.1.0');
      var head_init_time = obj.get('initial_time');
      var head_time = new Date(head_init_time + '+00:00').getTime();
      return head_time;
    }
    ...
    key: 'get_bitlender_paramers',
    value: function get_bitlender_paramers(type) {
      var key = ZosInstance.getOptionKey(type);
      return _zosjsWs.Apis.instance().db_api().exec('get_bitlender_paramers_key', [key]).then(function (res_paramers) {
    ...
    key: 'getCashBitAssetList',
    value: function getCashBitAssetList() {
      var result = {};
      return _zosjsWs.Apis.instance().bitlender_api().exec('get_asset_by_property', [0x00000001]).then(function (res_loan) {
        // 可借贷货币
        result['cash_list'] = res_loan;
        return _zosjsWs.Apis.instance().bitlender_api().exec('get_asset_by_property', [0x00000040]).then(function (res_lender) {
          // 可抵押货币
          result['bit_list'] = res_lender;
          result['cash_list'].forEach(function (item) {
          ...
          result['bit_list'].forEach(function (item) {
            item['isCashAsset'] = (item.uasset_property & 0x0000001) === 1;
            item['can_deposit'] = item.whitelist_gateways.length > 0 && item.id !== '1.3.0' && !item['isCashAsset'];
            item['can_withdraw'] = item.whitelist_gateways.length > 0 && item.id !== '1.3.0' && !item['isCashAsset'];
            item['can_transfer'] = !item['isCashAsset'];
    ...
    key: 'lookup_feeders',
    value: function lookup_feeders(asset_id) {
      var result = [];
      return _zosjsWs.Apis.instance().bitlender_api().exec('get_feeders', [asset_id]).then(function (res_list) {
        return new Promise(function (resolve, reject) {
          _async2.default.each(res_list, function (res, allcallback) {
            (0, _es.FetchChain)('getAccount', res, 5000).then(function (account_obj) {
              if (!account_obj) {
                allcallback(null);
              } else {
                var params = {};
    ...
    key: 'getBlockHeightTime',
    value: function getBlockHeightTime(height) {
      if (_es.ChainStore.getObject('2.0.0') && _es.ChainStore.getObject('2.1.0')) {
        var blockInterval = _es.ChainStore.getObject('2.0.0').get('parameters').get('block_interval'); // 几秒一个区块
        var headBlockNumber = _es.ChainStore.getObject('2.1.0').get('head_block_number'); // 最新的区块头
        var headBlockTime = new Date(_es.ChainStore.getObject('2.1.0').get('time') + '+00:00').getTime(); // 最新区块时间
        var secondsBelow = (headBlockNumber - height) * blockInterval;
    ...
    value: function getPrettyNameFee(account_name) {
      return _QueryChainStore2.default.getPrettyNameFee(account_name);
    }
    ...
    value: function bitlender_update_feed_producers_operation(issuer, option_id, author, new_feed_option) {
      var fee_asset_id = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : '1.3.0';

      var application_api = new _ApplicationApi2.default();

      return application_api.bitlender_update_feed_producers_operation(issuer, option_id, author, new_feed_option, fee_asset_id, // 手续费
      true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
    ...
    key: 'get_asset_exchange_feed',
    value: function get_asset_exchange_feed(borrow_asset_id, collateral_asset_id) {
      return _zosjsWs.Apis.instance().db_api().exec('get_asset_exchange_feed', [borrow_asset_id, collateral_asset_id, 1]).then(function (res_obj) {
    ...
    value: function finance_option_create(issuer, issue_asset_id, issue_asset_owner, buy_asset_id, fundraise_owner, options, url) {
      var fee_asset_id = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : '1.3.0';

      var application_api = new _ApplicationApi2.default();

      return application_api.finance_option_create(issuer, issue_asset_id, issue_asset_owner, buy_asset_id, fundraise_owner, options, url, fee_asset_id, // 手续费
      true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
    ...
    value: function finance_option_update(issuer, fundraise_id, issue_asset_owner, period, options, url, op_type) {
      var fee_asset_id = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : '1.3.0';

      var application_api = new _ApplicationApi2.default();

      return application_api.finance_option_update(issuer, fundraise_id, issue_asset_owner, period, options, url, op_type, fee_asset_id, // 手续费
      true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
    ...
    value: function buy_finance_create(issuer, fundraise_id, buy_amount, buy_asset_id, bimmediately) {
      var fee_asset_id = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : '1.3.0';

      var application_api = new _ApplicationApi2.default();

      var amount = { 'amount': buy_amount, 'asset_id': buy_asset_id };
      return application_api.buy_finance_create(issuer, fundraise_id, issue_asset_owner, amount, bimmediately, fee_asset_id, // 手续费
      true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
    ...
    value: function buy_finance_enable(issuer, buy_fundraise_id, benable) {
      var fee_asset_id = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '1.3.0';

      var application_api = new _ApplicationApi2.default();
      return application_api.buy_finance_enable(issuer, buy_fundraise_id, benable, fee_asset_id, // 手续费
      true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
    ...
    value: function issue_fundraise_remove(issuer, fundraise_id, issue_asset_owner) {
      var fee_asset_id = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '1.3.0';

      var application_api = new _ApplicationApi2.default();
      return application_api.issue_fundraise_remove(issuer, fundraise_id, issue_asset_owner, fee_asset_id, // 手续费
      true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
    ...
    value: function issue_fundraise_publish_feed(issuer, fundraise_id, period, feed_publiser, fundraise_price) {
      var fee_asset_id = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : '1.3.0';

      var application_api = new _ApplicationApi2.default();
      return application_api.issue_fundraise_publish_feed(issuer, fundraise_id, period, feed_publiser, fundraise_price, fee_asset_id, // 手续费
      true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
    ...
    key: 'addEventForAfterAutoLock',
    value: function addEventForAfterAutoLock(callback) {
      _WalletUnlockStore2.default.subscribe(callback);
    }

    // 删除一个登录自动锁定订阅事件

  }, {
    key: 'removeEventForAfterAutoLock',
    value: function removeEventForAfterAutoLock(callback) {
      _WalletUnlockStore2.default.unsubscribe(callback);
    }
    ...
    key: 'carrier_update',
    value: function carrier_update(carrier, carrier_account) {
      var new_config = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;
      var new_memo = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : undefined;
      var new_url = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : undefined;
      var need_auth = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : undefined;
      var fee_asset_id = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : '1.3.0';

      var application_api = new _ApplicationApi2.default();
      return application_api.carrier_update(carrier, carrier_account, new_config, new_memo, new_url, need_auth, fee_asset_id, // 手续费
      true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
    ...
    key: 'list_issue_fundraise',
    value: function list_issue_fundraise(sell_asset_id, buy_asset_id, ufiletermask, usort, start, limit) {
      return _zosjsWs.Apis.instance().finance_api().exec('list_issue_fundraise', [sell_asset_id, buy_asset_id, ufiletermask, usort, start, limit]).then(function (res) {
        return res;
      });
    }
    ...
    key: 'get_list_issue_fundraise_objs',
    value: function get_list_issue_fundraise_objs(arry_ids) {
      var result = [];
      return _zosjsWs.Apis.instance().db_api().exec('get_objects', [arry_ids]).then(function (res_list) {
        res_list.forEach(function (res) {
          res.options.forEach(function (res_options) {
            var options = res_options[1];
            if (options.enable) {
              // 此期有效
              var s_dt = options.option.start_time + 'Z';
              var s_time = new Date(s_dt).getTime();
              var e_dt = options.option.end_time + 'Z';
              var e_time = new Date(e_dt).getTime();
    ...
    value: function account_config_operation(issuer, config, op_type) {
      var fee_asset_id = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '1.3.0';

      var application_api = new _ApplicationApi2.default();
      return application_api.account_config_operation(issuer, config, op_type, fee_asset_id, // 手续费资产ID
      true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
    ...
    value: function account_authenticate(issuer, op_type, auth_data) {
      var fee_asset_id = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '1.3.0';

      var application_api = new _ApplicationApi2.default();
      return application_api.account_authenticate(issuer, op_type, auth_data, fee_asset_id, // 手续费资产ID
      true).then(function (tr) {
        var asset = _es.ChainStore.getObject(fee_asset_id);
        var tran_ser = tr.serialize();
        var fee_obj = {};
    ...
    key: 'get_account_allbalances',
    value: function get_account_allbalances(user_id) {
      ...
      ret['lockvesting'] = 0;
      ret['zos'] = 0;
      return _zosjsWs.Apis.instance().db_api().exec('get_account_balances_summary', [user_id, type | 0x00040 | 0x00080]).then(function (res_bal) {
        res_bal.forEach(function (bala) {
          var tmp_obj = bala;
    ...
    key: 'get_account_lock_balances',
    value: function get_account_lock_balances(user_id) {
      var result = [];
      return _zosjsWs.Apis.instance().db_api().exec('get_account_lock_balances', [user_id, 65535]).then(function (res_bal) {
        res_bal.forEach(function (bala) {
          var result_bal = {};
    ...
    key: 'getCollateralFeed',
    value: function getCollateralFeed(loanAssetID, base, quote) {
      var result = {};
      var _loanID = base.id;
      var _collID = quote.id;
      if (loanAssetID === quote.id) {
        _loanID = quote.id;
        _collID = base.id;
      }
      return _zosjsWs.Apis.instance().db_api().exec('get_asset_exchange_feed', [_loanID, _collID, 1]).then(function (res_obj) {
        result['balance'] = 0;
        result['maintenance_collateral_ratio'] = 0;
        result['maximum_short_squeeze_ratio'] = 0;
        result['feed_price'] = null;
        if (res_obj) {
          if (res_obj.current_feed) {
            if (res_obj.current_feed.settlement_price) {
              result['feed'] = res_obj.current_feed.settlement_price;
              result['feed_price'] = _QueryChainStore2.default.calcFeedPrice(res_obj.current_feed.settlement_price, base.id, base.precision, quote.id, quote.precision);
              result['feed_price_view'] = _QueryChainStore2.default.calcFeedPriceView(res_obj.current_feed.settlement_price, base.id, base.precision, quote.id, quote.precision);
            }
            result['maintenance_collateral_ratio'] = res_obj.current_feed.maintenance_collateral_ratio / 1000;
            result['maximum_short_squeeze_ratio'] = res_obj.current_feed.maximum_short_squeeze_ratio / 1000;
          }
    ...
    key: 'get_carrier_orders',
    value: function get_carrier_orders(carrier, order_type) {
      return _zosjsWs.Apis.instance().bitlender_api().exec('list_carrier_orders', [carrier, order_type]).then(function (list) {
        return list;
      });
    }
  }, {
    key: 'get_gateway',
    value: function get_gateway(admin_id, asset_id) {
      return _zosjsWs.Apis.instance().admin_api().exec('get_gateway', [admin_id, asset_id]).then(function (res) {
        if (res) {
    ...
    key: 'get_carrier',
    value: function get_carrier(admin_id, asset_id, type) {
      var key = ZosInstance.getOptionKey(type);
      return _zosjsWs.Apis.instance().admin_api().exec('get_carrier', [admin_id, asset_id, key]).then(function (account) {
        if (account) {
    ...
    key: 'get_authors',
    value: function get_authors(ids) {
      return _zosjsWs.Apis.instance().db_api().exec('get_authors', [ids]).then(function (account) {
    ...
    key: 'get_locktoken_object_data',
    value: function get_locktoken_object_data(x) {
      x.create_time = _QueryChainStore2.default.getTimezoneDate(x['create_time']).toString().replace('T', ' ');
      x.remove_time = _QueryChainStore2.default.getTimezoneDate(x['remove_time']).toString().replace('T', ' ');
      x.except_time = _QueryChainStore2.default.getTimezoneDate(x['except_time']).toString().replace('T', ' ');
      x.lastCoinDayTime = _QueryChainStore2.default.getTimezoneDate(x['lastCoinDayTime']).toString().replace('T', ' ');
      x.interest_list.forEach(function (item) {
        item[0] = _QueryChainStore2.default.getTimezoneDate(item[0]).toString().replace('T', ' ');
      });
      x.reward_list.forEach(function (item) {
        item[0] = _QueryChainStore2.default.getTimezoneDate(item[0]).toString().replace('T', ' ');
      });
      ...
      if (x.interest.asset_id === x.locked.asset_id) {
        ...
        x['price'] = _QueryChainStore2.default.calcFeedPrice(x.pay_price, x.pay_price.quote.asset_id, x.interestprecision, x.pay_price.base.asset_id, x.precision);
      }
    ...
    key: 'get_locktoken_history',
    value: function get_locktoken_history(acc, ass, type, ustart, ulimit) {
      var result = [];
      if (ass === '') ass = '1.3.100000000';
      return _zosjsWs.Apis.instance().history_api().exec('get_locktoken_history', [acc, ass, type, ustart, ulimit]).then(function (account) {
        return new Promise(function (resolve, reject) {
          _async2.default.each(account, function (res, allcallback) {
            var int_obj = ZosInstance.get_locktoken_object_data(res);
            result.push(int_obj);
          }, function (allerr) {
            if (allerr) {
              console.log('err', allerr);
    ...
    key: 'get_locktoken_history_count',
    value: function get_locktoken_history_count(acc, ass, type) {
      if (ass === '') ass = '1.3.100000000';
      return _zosjsWs.Apis.instance().history_api().exec('get_locktoken_history_count', [acc, ass, type]).then(function (account) {
        return account;
      }).catch(function (error) {
        console.log(error);
        return 0;
    ...
    key: 'get_locktoken_ids',
    value: function get_locktoken_ids(acc, ass, type) {
      var result = [];
      if (ass === '') ass = '1.3.100000000';
      return _zosjsWs.Apis.instance().db_api().exec('get_locktokens', [acc, ass, type]).then(function (account) {
        return account;
      }).catch(function (error) {
        console.log(error);
        return result;
    ...
    key: 'get_locktoken_history_objects',
    value: function get_locktoken_history_objects(id) {
      return _zosjsWs.Apis.instance().history_api().exec('get_object_history', [id]).then(function (res) {
        return ZosInstance.get_locktoken_object_data(res);
      });
    }
  }, {
    key: 'get_locktoken_objects',
    value: function get_locktoken_objects(ids) {
      var result = [];
      return _zosjsWs.Apis.instance().db_api().exec('get_objects', [ids]).then(function (account) {
        return new Promise(function (resolve, reject) {
          _async2.default.each(account, function (res, allcallback) {
            var int_obj = ZosInstance.get_locktoken_object_data(res);
            result.push(int_obj);
    ...
    key: 'getOptionSupport',
    value: function getOptionSupport(mode) {
      if (mode === undefined || mode === null) mode = 3;
      var Type = [];
      if (mode & 0x01) {
        var add = { label: 'm.invest.periodmode1', id: '33', des: 'm.invest.repayment1', disable: false };
        Type.push(add);
      }
      if (mode & 0x02) {
        var _add = { label: 'm.invest.periodmode3', id: '67', des: 'm.invest.repayment2', disable: false };
        Type.push(_add);
      }
      return Type;
    }
    ...
    key: 'getOptionKey',
    value: function getOptionKey(type) {
      ...
      var key = { repayment_period_uint: 1, repayment_type: 1, loan_mode: 0, op_type: 0 };
    ...
    key: 'getOptionKeyToValue',
    value: function getOptionKeyToValue(type) {
      return Number(type.repayment_type) * 32 + Number(type.repayment_period_uint);
    }
  }, {
    key: 'getOptionIndex',
    value: function getOptionIndex(type) {
      var value = ZosInstance.getOptionKey(type);
      if (value.repayment_period_uint === 1 && value.repayment_type === 1) return '';else return '-' + value.repayment_period_uint + '-' + value.repayment_type;
    }
    // 获取法币对应的借款产品信息
    // *参数：法币的id

  }, {
    key: 'getBitlenderOption',
    value: function getBitlenderOption(asset_id) {
      var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '33';

      var result = {};
      var key = ZosInstance.getOptionKey(type);
      return _zosjsWs.Apis.instance().db_api().exec('get_bitlender_option_key', [asset_id, key]).then(function (assets) {
        if (!assets) {
          result['isExiste'] = false; // 是否存在借贷参数
          // 如果没有，则找1.3.0的参数作为默认参数
          return _zosjsWs.Apis.instance().db_api().exec('get_bitlender_option_key', ['1.3.0', null]).then(function (cny_assets) {
            if (!cny_assets) {
            ...
            return _zosjsWs.Apis.instance().db_api().exec('get_objects', [[asset_id]]).then(function (assets) {
              if (assets && assets.length > 0) {
                var p = Math.pow(10, assets[0].precision);
    ...
    key: 'getRequiredFees',
    value: function getRequiredFees(tr) {
      var assetid = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '1.3.0';

      var options = [];
      for (var i = 0, op; i < tr.operations.length; i++) {
        op = tr.operations[i];
        options.push(_es.ops.operation.toObject(op));
      }
      return _zosjsWs.Apis.instance().db_api().exec('get_required_fees', [options, assetid]).then(function (res) {
        var res_asset = _es.ChainStore.getObject(assetid);
    ...
    key: 'list_bitlender_order',
    value: function list_bitlender_order(acc, loan_type, loan_asset_id, lender_asset_id, period, ufiletermask, usort) {
      if (!acc || acc === '') acc = '1.2.0';
      return _zosjsWs.Apis.instance().bitlender_api().exec('list_bitlender_order', [acc, loan_type, loan_asset_id, lender_asset_id, period, ufiletermask, usort]).then(function (res) {
        return res;
      });
    }
  }, {
    key: 'get_account_balance',
    value: function get_account_balance(user_id, asset_id) {
      return (0, _es.FetchChain)('getAccount', user_id, 5000).then(function (account) {
        return _es.ChainStore.getAccountBalance(account, asset_id);
      }).catch(function (error) {
        console.log(error);
        return Promise.reject(error);
      });
    ...
    key: 'get_loan_orders_by_order',
    value: function get_loan_orders_by_order(arry_orderids) {
      var result = [];
      return _zosjsWs.Apis.instance().bitlender_api().exec('get_loan_orders_by_id', [arry_orderids]).then(function (res_list) {
        return new Promise(function (resolve, reject) {
          _async2.default.each(res_list, function (res, allcallback) {
            if (!res) {
              allcallback(null);
            ...
            var int_obj = ZosInstance.get_loan_object_info(res);
            result.push(int_obj);
          }, function (allerr) {
            if (allerr) {
              console.log('err', allerr);
    ...
    key: 'get_invest_counts',
    value: function get_invest_counts(arry_account_id, arry_asset_id, arry_status) {
      return _zosjsWs.Apis.instance().db_api().exec('get_invest_counts', [arry_account_id, arry_asset_id, arry_status]).then(function (res) {
        return res;
      });
    }
    ...
    key: 'get_invest_repay_interest',
    value: function get_invest_repay_interest(res, order_info) {
    ...
    key: 'get_invest_object_data',
    value: function get_invest_object_data(res) {
      ZosInstance.get_invest_repay_interest(res, res.order_info);
      // 应标时间
      res['invest_time'] = _QueryChainStore2.default.getTimezoneDate(res['invest_time']);

      // 实际还本时间
      res['repay_principal_time'] = _QueryChainStore2.default.getTimezoneDate(res['repay_principal_time']);
      ...
      res.repay_interest.forEach(function (interest) {
        ...
        if (interest[1].interest_state === 2 || interest[1].interest_state === 4 || interest[1].interest_state === 6) {
          int_obj['finish_amount'] = (parseInt(interest[1].amount_repay_interest.amount) + parseInt(interest[1].fines_repay_interest.amount)) / Math.pow(10, res['loan_asset'].precision); // 实还金额(已处理精度)
          int_obj['finish_time'] = _QueryChainStore2.default.getTimezoneDate(interest[1].finish_time); // 实际还款时间
        } else {
          int_obj['finish_amount'] = 0;
          int_obj['finish_time'] = ''; // 实际还款时间
        }
        int_obj['amount_repay_interest'] = parseInt(interest[1].amount_repay_interest.amount) / Math.pow(10, res['loan_asset'].precision); // 实际还的利息
        int_obj['fines_repay_interest'] = parseInt(interest[1].fines_repay_interest.amount) / Math.pow(10, res['loan_asset'].precision); // 罚息资产
        int_obj['expect_time'] = _QueryChainStore2.default.getTimezoneDate(interest[1].expect_time); // 预计还款时间
        int_obj['interest_rate'] = interest[1].interest_rate.interest_rate; // 利率
        int_obj['interest_state'] = interest[1].interest_state; // 状态
        interest[1] = int_obj;
      });
      ...
      res['repay_interest_rate'] = res['repay_interest_sum'] / res['invest_amount']; // 实际收益率
      var order_info = ZosInstance.get_loan_object_data(res['order_info']);
      res['order_info'] = order_info;
      res['tableListData'] = order_info.tableListData;
      res['tableListData']['interestData'] = res.repay_interest;
      var finish = res.order_info.order_state === 7 || res.order_info.order_state === 8 || res.order_info.order_state === 9 || res.order_info.order_state === 13;
      var tablePrincipal = [{
    ...
    key: 'get_invest_object_info',
    value: function get_invest_object_info(res) {
      // 应标时间
      res['invest_time'] = _QueryChainStore2.default.getTimezoneDate(res['invest_time']);
      ...
      res.order_info.repay_interest.forEach(function (interest) {
        if (interest[1].interest_state === 2 || interest[1].interest_state === 4) {
          var rate = res['invest_amount'] * interest[1].amount_repay_interest.amount / res.amount_to_loan.amount;
          interest_sum += rate;
        }
        expect_sum = expect_sum + parseInt(interest[1].expect_repay_interest.amount);
      });
      ...
      res['expect_sum'] = expect_sum;
      res['repay_interest_rate'] = res['repay_interest_sum'] / res['invest_amount']; // 实际收益率
      var order_info = ZosInstance.get_loan_object_info(res['order_info']);
      res['order_info'] = order_info;
      return res;
    }
    // 获取排序后的借款列表
    ...
    key: 'get_invest_orders_by_order',
    value: function get_invest_orders_by_order(arry_orderids) {
      var result = [];
      return _zosjsWs.Apis.instance().bitlender_api().exec('get_invest_orders_by_id', [arry_orderids]).then(function (res_list) {
        return new Promise(function (resolve, reject) {
          _async2.default.each(res_list, function (res, allcallback) {
            if (!res) {
              allcallback(null);
            ...
            var int_obj = ZosInstance.get_invest_object_info(res);
            result.push(int_obj);
          }, function (allerr) {
            if (allerr) {
              console.log('err', allerr);
    ...
    key: 'get_invest_orders',
    value: function get_invest_orders(arry_account_id, arry_asset_id, arry_status, start, limit) {
      var result = [];
      return _zosjsWs.Apis.instance().db_api().exec('get_invest_orders', [arry_account_id, arry_asset_id, arry_status, start, limit]).then(function (res_list) {
        return new Promise(function (resolve, reject) {
          _async2.default.each(res_list, function (res, allcallback) {
            if (!res) {
              allcallback(null);
    ...
    key: 'get_loan_counts',
    value: function get_loan_counts(arry_account_id, arry_asset_id, arry_status) {
      return _zosjsWs.Apis.instance().db_api().exec('get_loan_counts', [arry_account_id, arry_asset_id, arry_status]).then(function (res) {
        return res;
      });
    }
    // 获取借款列表
    ...
    key: 'get_loan_orders',
    value: function get_loan_orders(arry_acount_id, arry_asset_id, arry_status, start, limit) {
      var result = [];
      return _zosjsWs.Apis.instance().db_api().exec('get_loan_orders', [arry_acount_id, arry_asset_id, arry_status, start, limit]).then(function (res_list) {
        return new Promise(function (resolve, reject) {
          _async2.default.each(res_list, function (res, allcallback) {
            if (!res) {
              allcallback(null);
    ...
    key: 'get_bitlender_loan_history_summary',
    value: function get_bitlender_loan_history_summary(type) {
      var result = [];
      ...
      return _zosjsWs.Apis.instance().history_api().exec('get_bitlender_loan_history', ['1.3.0', '1.3.0', type]).then(function (res_list) {
        return new Promise(function (resolve, reject) {
          _async2.default.each(res_list, function (res, allcallback) {
            if (!res) {
              allcallback(null);
    ...
    key: 'get_account_invest_history_count',
    value: function get_account_invest_history_count(account_id, start, end) {
      return _zosjsWs.Apis.instance().history_api().exec('get_account_invest_history_count', [account_id, start, end]).then(function (res) {
        return res;
      });
    }
  }, {
    key: 'get_account_invest_history',
    value: function get_account_invest_history(account_id, start, end, startIndex, pagesize) {
      var result = [];
      return _zosjsWs.Apis.instance().history_api().exec('get_account_invest_history', [account_id, start, end, startIndex, pagesize]).then(function (res_list) {
        return new Promise(function (resolve, reject) {
          _async2.default.each(res_list, function (res, allcallback) {
            if (!res) {
              allcallback(null);
    ...
    key: 'get_account_loan_history_count',
    value: function get_account_loan_history_count(account_id, start, end) {
      return _zosjsWs.Apis.instance().history_api().exec('get_account_loan_history_count', [account_id, start, end]).then(function (res) {
        return res;
      });
    }
    // Eirc
    ...
    key: 'get_loan_object_info',
    value: function get_loan_object_info(res) {
      // 处理时区
      // tzo: TimeZoneOffset; 格林威治时间和本地时间之间的时差
      // 挂单截止时间
      res['expiration_time'] = _QueryChainStore2.default.getTimezoneDate(res['expiration_time']);
      // 满标时间
      res['invest_finish_time'] = _QueryChainStore2.default.getTimezoneDate(res['invest_finish_time']);
      // 借款时间
      res['loan_time'] = _QueryChainStore2.default.getTimezoneDate(res['loan_time']);
      // 实际还本时间
      res['repay_principal_time'] = _QueryChainStore2.default.getTimezoneDate(res['repay_principal_time']);
      // 预计还本时间
      res['expect_principal_time'] = _QueryChainStore2.default.getTimezoneDate(res['expect_principal_time']);
      // 不良资产逾期时间
      res['overdue_recycle_time'] = _QueryChainStore2.default.getTimezoneDate(res['overdue_recycle_time']);

      res['collateralize_asset'] = res.asset_to_collateralize; // 抵押资产的具体信息
      res['loan_asset'] = res.asset_to_loan; // 借款资产的具体信息
      // 还款总金额
      var repay_amount_sum = parseInt(res.amount_to_loan.amount);
      var expect_sum = 0;
      repay_amount_sum = repay_amount_sum + parseInt(res.repay_principal_fee.amount);
      res.repay_interest.forEach(function (interest) {
        repay_amount_sum = repay_amount_sum + parseInt(interest[1].amount_repay_interest.amount) + parseInt(interest[1].fines_repay_interest.amount);
      ...
      res['cur_feed'] = _QueryChainStore2.default.calcFeedPrice(res.current_feed.settlement_price, res.asset_to_collateralize.id, res.asset_to_collateralize.precision, res.asset_to_loan.id, res.asset_to_loan.precision);
      res['cur_feed_view'] = _QueryChainStore2.default.calcFeedPriceView(res.current_feed.settlement_price, res.asset_to_loan.id, res.asset_to_loan.precision, res.asset_to_collateralize.id, res.asset_to_collateralize.precision);
    ...
    key: 'get_account_notify_orders',
    value: function get_account_notify_orders(account_id, status, start, limit) {
      var result = [];
      return _zosjsWs.Apis.instance().db_api().exec('get_account_notify_orders', [account_id, status, start, limit]).then(function (res_list) {
        return new Promise(function (resolve, reject) {
          _async2.default.each(res_list, function (res, allcallback) {
            if (!res) {
              allcallback(null);
    ...
    key: 'get_account_loan_history',
    value: function get_account_loan_history(account_id, start, end, startIndex, pagesize) {
      var result = [];
      return _zosjsWs.Apis.instance().history_api().exec('get_account_loan_history', [account_id, start, end, startIndex, pagesize]).then(function (res_list) {
        return new Promise(function (resolve, reject) {
          _async2.default.each(res_list, function (res, allcallback) {
            if (!res) {
              allcallback(null);
    ...
    key: 'get_loan_object_data',
    value: function get_loan_object_data(res_obj) {
      var result = res_obj;
      ...
      result['expiration_time'] = _QueryChainStore2.default.getTimezoneDate(res_obj['expiration_time']);

      // 满标时间
      result['invest_finish_time'] = _QueryChainStore2.default.getTimezoneDate(res_obj['invest_finish_time']);
      result['notify_time'] = _QueryChainStore2.default.getTimezoneDate(res_obj.notify_time);

      // 借款时间
      result['loan_time'] = _QueryChainStore2.default.getTimezoneDate(res_obj['loan_time']);
      ...
      if (res_obj.order_state === 7 || res_obj.order_state === 8 || res_obj.order_state === 9) {
        result['repay_principal_time'] = _QueryChainStore2.default.getTimezoneDate(res_obj['repay_principal_time']);
      ...
      // 预计还本时间
      result['expect_principal_time'] = _QueryChainStore2.default.getTimezoneDate(res_obj['expect_principal_time']);

      // 不良资产逾期时间
      result['overdue_recycle_time'] = _QueryChainStore2.default.getTimezoneDate(res_obj['overdue_recycle_time']);
      // 下单时喂价
      ...
      result['cur_feed'] = _QueryChainStore2.default.calcFeedPrice(res_obj.current_feed.settlement_price, res_obj.asset_to_collateralize.id, res_obj.asset_to_collateralize.precision, res_obj.asset_to_loan.id, res_obj.asset_to_loan.precision);
      result['cur_feed_view'] = _QueryChainStore2.default.calcFeedPriceView(res_obj.current_feed.settlement_price, res_obj.asset_to_loan.id, res_obj.asset_to_loan.precision, res_obj.asset_to_collateralize.id, res_obj.asset_to_collateralize.precision);
      result['deal_feed'] = _QueryChainStore2.default.calcFeedPrice(price_settlement_feed, res_obj.asset_to_collateralize.id, res_obj.asset_to_collateralize.precision, res_obj.asset_to_loan.id, res_obj.asset_to_loan.precision);
      ...
      res_obj.interest_book.forEach(function (interest) {
        ...
        interest[1]['time'] = _QueryChainStore2.default.getTimezoneDate(interest[1].invest_time); // 投资时间
      ...
      // 费用
      var fee = [res_obj.collateralize_fee, res_obj.collateralize_risk, res_obj.carrier_fee];
      var asset = [res_obj.asset_to_fee, res_obj.asset_to_fee, res_obj.asset_to_loan];
      var feeData = {
      ...
      var finish = res_obj.order_state === 7 || res_obj.order_state === 8 || res_obj.order_state === 9 || res_obj.order_state === 13;
      var tablePrincipal = [{
    ...
    key: 'get_invest_object',
    value: function get_invest_object(investid // 借款订单ID
    ) {
      return _zosjsWs.Apis.instance().bitlender_api().exec('get_invest_order', [investid, true]).then(function (res_obj) {
    ...
    key: 'get_invest_object_history',
    value: function get_invest_object_history(investid // 投资订单ID
    ) {
      return _zosjsWs.Apis.instance().history_api().exec('get_object_history', [investid]).then(function (res_borrow) {
        return ZosInstance.get_invest_object_data(res_borrow);
      });
    }
  }, {
    key: 'get_loan_object_ex',
    value: function get_loan_object_ex(order_id, his) {
      if (his) {
    ...
    key: 'get_invest_object_ex',
    value: function get_invest_object_ex(order_id, his) {
      if (his) {
    ...
    key: 'get_loan_object_history',
    value: function get_loan_object_history(order_id) {
      return _zosjsWs.Apis.instance().history_api().exec('get_object_history', [order_id]).then(function (res_obj) {
    ...
    key: 'get_loan_object',
    value: function get_loan_object(order_id // 订单ID
    ) {
      return _zosjsWs.Apis.instance().bitlender_api().exec('get_loan_order', [order_id]).then(function (res_obj) {
        return ZosInstance.get_loan_object_data(res_obj);
      });
    }
  }, {
    key: 'formatProposalTime',
    value: function formatProposalTime(str) {
      function add(m) {
        return m < 10 ? '0' + m : m;
      }
    ...
    key: 'getTimezoneDateByGmt',
    value: function getTimezoneDateByGmt(x) {
      var offset = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;

      var get = new Date(x);
      if (offset > 0) get = new Date(get.getTime() + offset * 60 * 60 * 1000);
      return _QueryChainStore2.default.formatDate(get);
    }
  }, {
    key: 'getTimezoneDateByUnix',
    value: function getTimezoneDateByUnix(x) {
    ...
    key: 'getTimezoneDate',
    value: function getTimezoneDate(x) {
      return _QueryChainStore2.default.getTimezoneDate(x);
    }
  }]);
