...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 通过路由改变导航文字样式
      getPage () {
        if (this.$route.path === '/kyc/kyclist') {
          this.changePage(1)
        } else if (this.$route.path === '/kyc/kyc_setting') {
          this.changePage(2)
        } else if (this.$route.path === '/kyc/kyc_statistics') {
          this.changePage(3)
        }
      }
    },
