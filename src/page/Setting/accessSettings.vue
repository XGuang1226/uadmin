<template>
    <div v-loading="loading" :element-loading-text="$t('m.Frame.loading')" style="min-height: 10vw;">
      ...
      :before-close="formHandleClose">
        <div v-loading="loading" :element-loading-text="$t('m.Setting.applyWaiting')" style="min-height: 10vw">
        ...
        <span slot="footer" class="dialog-footer">
          <el-button @click="resetForm('ruleForm')">{{$t('m.Setting.cancel')}}</el-button>
          <el-button type="primary" @click="onAddSubmit('ruleForm')">{{$t('m.Setting.sure')}}</el-button>
        </span>
      </el-dialog>
      <!--删除节点-->
      <el-dialog
      ...
      :before-close="handleClose">
        ...
        <span slot="footer" class="dialog-footer">
          <el-button @click="removeWebsocketDialogVisible=false">{{$t('m.Setting.cancel')}}</el-button>
          <el-button type="primary" @click="onRemoveSubmit">{{$t('m.Setting.sure')}}</el-button>
        </span>
      </el-dialog>
