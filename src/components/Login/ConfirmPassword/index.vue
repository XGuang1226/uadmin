<template>
    <div>
      <el-dialog
        :title="$t('m.Setting.inputPassword')"
        @close="close"
        ...
        <span slot="footer" class="dialog-footer">
          <el-button @click="close(); password=''">{{$t('m.Setting.cancel')}}</el-button>
          <el-button type="primary" @click="accountSubmit">{{$t('m.Setting.sure')}}</el-button>
        </span>
      </el-dialog>
    </div>
</template>
